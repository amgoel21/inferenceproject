...
def decode(ciphertext: str, has_breakpoint: bool) -> str:
    ...
    while(badentropy):
        ...
        p1,e1,c1=decode1(ciphertext[:currentbreakpoint],has_breakpoint=False,f0=f01,iters=15000)
        #print("E1: "+str(e1))
        ...
        if(e1>3.6):
            ...
            badnetropy=True
            p2,e2,c2 = decode1(ciphertext[currentbreakpoint:],has_breakpoint=False,f0=f02,iters=15000)
            return p1+p2
        else:
            p2,e2,c2=decode1(ciphertext[currentbreakpoint:],has_breakpoint=False,f0=f01,iters=15000)
            if(e2>3.6):
                prevbreak = currentbreakpoint
